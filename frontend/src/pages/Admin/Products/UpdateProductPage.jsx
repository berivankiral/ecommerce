      ...
      try {
        ...
        if (singleProductData) {
          form.setFieldsValue({
            ...
            img: Array.isArray(singleProductData.img) ? singleProductData.img.join("\n") : "",
            // colors: Array.isArray(singleProductData.colors) ? singleProductData.colors.join("\n") : "",
            // sizes: Array.isArray(singleProductData.sizes) ? singleProductData.sizes.join("\n") : "",
            category: singleProductData.category,
          });
          if(editor){
            editor.commands.setContent(singleProductData.description || "");
          }
        }
      } catch (error) {
  ...
  return (
    <Spin spinning={loading}>
      <Form name="basic" layout="vertical" onFinish={onFinish} form={form}>
        ...
        <Form.Item label="Ürün Açıklaması" required>
          <div style={{ border: "1px solid #ccc", borderRadius: 4, padding: 8, backgroundColor: "white" }}>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Lütfen ürün görsellerini ekleyiniz.",
            },
          ]}
        >
          <Input.TextArea
